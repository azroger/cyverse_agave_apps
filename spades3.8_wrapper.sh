#!/bin/bash
#SPAdes wrapper script Roger Barthelson 2016

tar xvzf SPAdes-3.8.0-Linux.tar.gz
...
SPAdes-3.8.0-Linux/bin/spades.py -o Spades_Output $Stuff -k $kmer $Options -m 64 -t 24

rm -r SPAdes-3.8.0-Linux
